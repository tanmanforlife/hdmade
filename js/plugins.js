...
/*
 * Make it safe to use console.log in any browser
 */
...
CountUp.prototype.updateCounter=function(){
    ...
    this.formatTime();
 //   console.log(this);
//console.log(this.countainer);
	if(this.countainer != null) {
...
(function ( $ ) {
	...
	var methods = {
		...
		print : function(time, newOptions) {
			var wrapperElement = '<div class="digits">';
			var year   = '<span id='+newOptions["class_prefix"]+'_year">'+time.year+' '+_lang[newOptions['lang']].year+newOptions['seperator']+' </span>';
			var month  = '<span id='+newOptions["class_prefix"]+'_month">'+time.month+' '+_lang[newOptions['lang']].month+newOptions['seperator']+' </span>';
			var day    = '<span id='+newOptions["class_prefix"]+'_day">'+time.day+' '+_lang[newOptions['lang']].day+newOptions['seperator']+' </span>';
		//	var hour   = '<span id='+newOptions["class_prefix"]+'_hour" class="unit">'+time.hour+' '+_lang[newOptions['lang']].hour+newOptions['seperator']+' </span>';
		//	var minute = '<span id='+newOptions["class_prefix"]+'_minute" class="unit">'+time.minute+' '+_lang[newOptions['lang']].minute+newOptions['seperator']+' </span>';
		//	var seconds = '<span id='+newOptions["class_prefix"]+'_seconds" class="unit">'+time.seconds+' '+_lang[newOptions['lang']].seconds+' </span>';
			var hour   = '<span id='+newOptions["class_prefix"]+'_hour" class="unit">'+time.hour+' <span class="timer-unit">Hours</span></span>';
			var minute = '<span id='+newOptions["class_prefix"]+'_minute" class="unit">'+time.minute+' <span class="timer-unit">Minutes</span></span>';
			var seconds = '<span id='+newOptions["class_prefix"]+'_seconds" class="unit">'+time.seconds+'<span class="timer-unit">Seconds</span></span>';
		
			var endWrapperElement = '</div>';
			var totalTime = wrapperElement + hour + minute + seconds + endWrapperElement;
			if(newOptions['write_zero'] == 'true') {
				$(newOptions['div_id']).html(year+month+day+hour+minute+seconds);
			} else {
				$(newOptions['div_id']).html(null);
				...
				if((time.seconds > 0) ||  zero)
					$(newOptions['div_id']).append(totalTime);				
			}
		},
