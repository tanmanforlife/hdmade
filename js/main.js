    ...
    $.ajax({
        ...
        success: function(data, textStatus, xhr) {
             var items = [];
              $.each(data, function(i, tweet) {
                    var timeago = relative_time(tweet.created_at);
                    items.push('<li class="jta-tweet-list-item"><div class="jta-tweet-profile-image"><a class="jta-tweet-profile-image-link" href="http://twitter.com/'+tweet.from_user_name+'" target="_blank"><img src="'+tweet.profile_image_url+'" alt="'+tweet.from_user_name+'" title="'+tweet.from_user_name+'"></a></div>');
                    //<div class="jta-tweet-body jta-tweet-body-list-profile-image-present"><span class="jta-tweet-text"><span class="jta-tweet-user-name"><span class="jta-tweet-user-screen-name"><a class="jta-tweet-user-screen-name-link" href="http://twitter.com/121212Concert" target="_blank">121212Concert</a></span> <span class="jta-tweet-user-full-name"> <a class="jta-tweet-user-full-name-link" href="http://twitter.com/121212Concert" name="121212Concert" target="_blank">121212 Concert</a></span></span> Thanks for your support!! <a href="http://search.twitter.com/search?q=%23121212concert" class="jta-tweet-a jta-tweet-hashtag" title="#121212concert" target="_blank" rel="nofollow">#121212concert</a> RT @<a href="http://twitter.com/hellrider2131" class="jta-tweet-a twitter-anywhere-user" target="_blank" rel="nofollow">hellrider2131</a>: @<a href="http://twitter.com/nyyankeechick" class="jta-tweet-a twitter-anywhere-user" target="_blank" rel="nofollow">nyyankeechick</a> @<a href="http://twitter.com/121212Concert" class="jta-tweet-a twitter-anywhere-user" target="_blank" rel="nofollow">121212Concert</a> This will be a great concert for a great cause</span><span class="jta-tweet-attributes"><span class="jta-tweet-twitter-bird"><a href="https://twitter.com/intent/user?screen_name=121212Concert" target="_blank" title="121212Concert on Twitter"><span class="jta-tweet-twitter-bird-icon">&nbsp;</span></a></span><span class="jta-tweet-timestamp"><a class="jta-tweet-timestamp-link" data-timestamp="Fri, Dec 07 2012 16:03:40 +0000" href="http://twitter.com/121212Concert/status/277080945763442688" target="_blank" title="Fri Dec 07 2012 11:03:40 GMT-0500 (EST)">59 minutes ago</a></span></span><span class="jta-tweet-actions"><span class="jta-tweet-action-retweet"><a href="https://twitter.com/intent/retweet?tweet_id=277080945763442688">Retweet</a></span></span></div><div class="jta-clear">&nbsp;</div></li>
              });
              $('<div/>', {
